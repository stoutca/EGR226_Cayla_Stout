...
volatile uint32_t detect10Hz; //global flag variable to tell program if timerA0 input capture interrupt happened
volatile uint16_t lastedge, currentedge, P; //global variables for use in the interrupt handler
