...
void main(void)
{
    ...
    const int time_delay = 1000; //variable to control ms delay between light changes
...
* N/A
*************************************************************/
void delay(const int num_miliseconds)
{
    int i;
    for(i = num_miliseconds; i > 0; i--) //delay that can change with the value of the wait parameter. The parameter is the number of miliseconds you want to wait for
    {
