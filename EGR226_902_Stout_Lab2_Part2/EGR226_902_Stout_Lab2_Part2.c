...
* Course: EGR 226 - 902
* Date: 01/27/2021
* Project: Lab 02 Part 2 - Searchable Book Database
* File: ResistorAnalysis.c
* Description: Application that reads in a book list and prompts the user to search through the
list using keywords, titles, authors, and ISBN numbers
***************************************************************************************************/
